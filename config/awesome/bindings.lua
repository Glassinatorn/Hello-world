...
Globalkeys = gears.table.join(
    ...
    -- client focus
    awful.key({vars.MODKEY}, "h", function() awful.client.focus.bydirection("left") end, {description = "focus client to the left", group = "client"}),
    awful.key({vars.MODKEY}, "j", function() awful.client.focus.bydirection("down") end, {description = "focus client below", group = "client"}),
    awful.key({vars.MODKEY}, "k", function() awful.client.focus.bydirection("up") end, {description = "focus client above", group = "client"}),
    awful.key({vars.MODKEY}, "l", function() awful.client.focus.bydirection("right") end, {description = "focus client to the right", group = "client"}),
    -- local layout
